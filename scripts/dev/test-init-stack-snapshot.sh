...
assert_contains "## Approach" "$CLAUDE_FILE"
assert_contains "- Keep solutions simple and direct. Avoid over-engineering." "$CLAUDE_FILE"
assert_contains "- If the client supports it, suggest running \`/cost\` when a session runs long." "$CLAUDE_FILE"
assert_contains "## Output" "$CLAUDE_FILE"
assert_contains "- Avoid sycophantic openers, closers, and filler." "$CLAUDE_FILE"
...
assert_contains "## Approach" "$AGENTS_FILE"
assert_contains "- Keep solutions simple and direct. Avoid over-engineering." "$AGENTS_FILE"
assert_not_contains "/cost" "$AGENTS_FILE"
assert_contains "## Approach" "$GEMINI_FILE"
assert_contains "- Keep solutions simple and direct. Avoid over-engineering." "$GEMINI_FILE"
