...
- **Standard:** Laravel 11 / PHP 8.3
- **Patterns:** Service Layer for business logic, Actions for single-purpose operations, DTOs for type-safe data transfer.
- **Nova:** Use Laravel Nova 5 for admin interfaces; keep Nova resources thin and use Policies for authorization.

## 💎 Code Quality Standards
- **Type Safety:** Strict typing is mandatory. Every parameter, return, and property must be typed (PHP 8.3+).
